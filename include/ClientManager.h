...
void StartServer(const IInputDevice& i_inputDevice, utils::IMessageQueue& i_updateQueue, utils::IYielder& i_yielder, utils::async_waitable<void>* o_asyncWaitForServerStarted, std::ostream& i_ostream = std::cout);